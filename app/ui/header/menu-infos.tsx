...
export default function MenuInfos({ setIsOpen, isOpen }: MenuInfoProps) {
  ...
  return (
    <div
      ...
      aria-modal={isOpen}
      className={clsx(
        "fixed overflow-auto top-0 right-0 w-full h-screen bg-background min-sm:w-3/5 min-lg:w-2/5 transition-transform duration-700",
    ...
    >
      ...
      {/* Logo */}
      <Link className="block ml-6 mr-6" href={"/"}>
        <Image
