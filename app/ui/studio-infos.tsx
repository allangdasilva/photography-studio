            ...
            <li className="fontBody" key={index}>
              <div className="flex gap-3">
                ...
                {!link ? (
                  ...
                  <a
                    className="relative block font-medium after:absolute after:w-full after:h-[1px] after:-bottom-1 after:left-0 after:scale-x-0 hover:after:scale-x-100 focus:after:scale-x-100 after:origin-left after:bg-primaryColor after:transition-transform after:duration-700"
                    href={link}
                  >
                    {content}
                  </a>
